      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-zinc-900 via-zinc-900/90 to-zinc-900 border border-zinc-800 p-4 sm:p-8 shadow-xl">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="bg-zinc-950/80 border border-zinc-800 rounded-xl p-4 w-full sm:w-auto sm:min-w-[220px] space-y-3 shadow-inner">
            ...
            <Link
              href="/leaderboard"
              className="w-full py-2 px-3 rounded-lg bg-zinc-800 hover:bg-zinc-700/80 text-primary-300 font-semibold text-xs flex items-center justify-center gap-2 border border-zinc-700/50 transition-colors"
            >
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-4 px-4">
                        <div className="font-semibold text-zinc-100 group-hover:text-primary-300 transition-colors text-sm">
                          {p.title}
                        </div>
                      ...
                      {/* Points */}
                      <td className="py-4 px-4 text-center font-mono font-bold text-primary-300">
                        +{p.points} pts
                      </td>
                      ...
                      <td className="py-4 px-4 text-right">
                        <Link
                          ...
                          className="px-3 py-1.5 rounded-lg bg-zinc-800 group-hover:bg-primary-500 text-zinc-300 group-hover:text-zinc-950 font-bold text-xs inline-flex items-center gap-1.5 transition-all shadow-sm"
                        >
                          <span>Solve</span>
